    ...
    <div className="App">
      <header className="App-header">
        ...
        <a href="https://pump.fun/9MjHBVmtDh8HiFGtcoUtMqd39NB9yyumQ7qnGxyXpump" target="_blank" 
           className="ml-4 px-5 py-3 bg-white/5 hover:bg-white/10 border-2 border-[#c5a46e]/70 rounded-2xl text-lg font-semibold font-mono text-[#c5a46e] hover:underline tracking-wider transition hover:scale-105 shadow-lg">9MjHBVmtDh8HiFGtcoUtMqd39NB9yyumQ7qnGxyXpump</a>
